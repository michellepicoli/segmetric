...
test_that("normal use test values", {
    ...
    expect_equal(mean(test_OS2(y_prime)), summary(sm_compute(data, "OS2"))[[1]])
    expect_equal(mean(test_US2(y_prime)), summary(sm_compute(data, "US2"))[[1]])
    expect_equal(mean(test_OS1(y_star)), summary(sm_compute(data, "OS1"))[[1]])
    expect_equal(mean(test_US1(y_star)), summary(sm_compute(data, "US1"))[[1]])
    expect_equal(mean(test_overMerging(y_star)), 
                 summary(sm_compute(data, "OMerging"))[[1]])
    expect_equal(mean(test_underMerging(y_star)), 
                 summary(sm_compute(data, "UMerging"))[[1]])
    expect_equal(mean(test_AFI(y_prime)), summary(sm_compute(data, "AFI"))[[1]])
    expect_equal(mean(test_QR(y_star)), summary(sm_compute(data, "QR"))[[1]])
    expect_equal(mean(test_D_index(y_star)), 
                 summary(sm_compute(data, "D_index"))[[1]])
    expect_equal(mean(test_precision(x_prime)), 
                 summary(sm_compute(data, "precision"))[[1]])
    expect_equal(mean(test_recall(y_prime)), 
                 summary(sm_compute(data, "recall"))[[1]])
    expect_equal(mean(test_M(y_prime)), summary(sm_compute(data, "M"))[[1]])
    expect_equal(mean(test_RAsub(y_tilde)), 
                 summary(sm_compute(data, "RAsub"))[[1]])
    expect_equal(mean(test_RAsuper(y_tilde)), 
                 summary(sm_compute(data, "RAsuper"))[[1]])
    expect_equal(mean(test_PI(y_tilde)), summary(sm_compute(data, "PI"))[[1]])
    expect_true(sm_is_empty(sm_compute(data, "OS3"))[[1]])
    expect_true(sm_is_empty(sm_compute(data, "US3"))[[1]])
    expect_true(sm_is_empty(sm_compute(data, "ED3"))[[1]])
    expect_equal(
        mean(test_F_measure(test_precision(x_prime), test_recall(y_prime))),
        summary(sm_compute(data, "F_measure"))[[1]]
    )
    expect_equal(mean(test_E(x_prime)), summary(sm_compute(data, "E"))[[1]])
})
...
test_that("perfect fit test values", {
    ...
    expect_equal(mean(test_RAsuper(y_tilde)), 
                 summary(sm_compute(data, "RAsuper"))[[1]])
    expect_equal(mean(test_PI(y_tilde)), summary(sm_compute(data, "PI"))[[1]])
    expect_equal(mean(test_OS3(y_cd)), summary(sm_compute(data, "OS3"))[[1]])
    expect_equal(mean(test_US3(y_cd)), summary(sm_compute(data, "US3"))[[1]])
    expect_equal(mean(test_ED3(area_df)), summary(sm_compute(data, "ED3"))[[1]])
    expect_equal(
