...
test_that("empty intersection works", {
    ...
    expect_true(length(sm_compute(data, "QR")$QR) == 0)
    ...
    expect_true(length(sm_compute(data, "M")$M) == 0)
    
    expect_true(is.numeric(sm_compute(data, "E")$E))
    expect_true(length(sm_compute(data, "E")$E) == 0)
    
    expect_true(is.numeric(sm_compute(data, "RAsub")$RAsub))
    expect_true(length(sm_compute(data, "RAsub")$RAsub) == 0)
    
    expect_true(is.numeric(sm_compute(data, "RAsuper")$RAsuper))
    expect_true(length(sm_compute(data, "RAsuper")$RAsuper) == 0)
    
    expect_true(is.numeric(sm_compute(data, "PI")$PI))
    expect_true(length(sm_compute(data, "PI")$PI) == 0)
    ...
    expect_true(is.na(sm_compute(data, "UMerging")$UMerging))
    
    expect_true(is.na(sm_compute(data, "OMerging")$OMerging))
    
    expect_true(is.numeric(sm_compute(data, "F")$F))
    expect_true(length(sm_compute(data, "F")$F) == 0)
