...
ref_sf <- sf::read_sf(ref_shp)
seg_sf <- sf::read_sf(seg_shp)

data_lst <- list(ref_sf = ref_sf, 
                 seg_sf = seg_sf)
...
get_metric(data = data_lst, metric = "oseg", summary = "mean")
get_metric(data = data_lst, metric = "oseg", summary = "w_mean", 
           weight_field = "inter_area")

get_metric(data = data_lst, metric = "useg", summary = "identity")

get_metric(data = data_lst, metric = "useg", summary = "w_mean", 
           weight_field = "inter_area")
```
