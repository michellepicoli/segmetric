...
#' @docType package
#' 
#' @description Segmentation metrics for geospatial applications
#'
#' @section Purpose:
#'
#' `segmetric` package provides a set of metrics for analysis, 
#' and evaluation of geospatial segmentation.
#' 
#' It includes more than 20 metrics used in specialized literature for 
#' spatial segmentation assessment (Van Rijsbergen, 1979; 
#' Levine and Nazif, 1982; Janssen and Molenaar, 1995; Lucieer and Stein, 2002; 
#' Carleer et al., 2005; Moller et al., 2007; van Coillie et al., 2008; 
#' Costa et al., 2008; Weidner, 2008; Feitosa et al., 2010; Clinton et al. 2010; 
#' Persello and Bruzzone, 2010; Yang et al., 2014; and Zhang et al., 2015).
#' 
#' @section Extensions:
#' 
#' `segmetric` package is extensible and provides a set of functions
#' to facilitate implementation of new metrics. See `?sm_reg_metric()`
#' to see how new metrics can be implemented.
#' 
#' @section Contributions:
#' 
#' `segmetric` package is maintained on 
#' [github](https://github.com/michellepicoli/segmetric)...
#' 
#' @references 
